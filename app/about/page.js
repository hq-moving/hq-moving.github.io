    ...
    <>
      ...
      <main className="pt-24 pb-12 bg-white dark:bg-gray-950">
        <div className="max-w-6xl mx-auto px-4 md:px-12">
          <h1 className="text-3xl md:text-5xl font-bold text-brand mb-6">About Headquarters Moving LLC</h1>
          <div className="flex flex-col lg:flex-row gap-10 items-start">
            ...
            <div className="lg:w-1/2 space-y-6 text-lg text-body">
              ...
              <p>Our team has built a strong reputation for <strong className="text-brand">office furniture installation</strong> — assembling workstations, configuring cubicle systems, and managing decommissioning projects with precision and care.</p>
              <Link href="/contact" className="text-white bg-brand hover:bg-brand-dark inline-flex items-center px-6 py-3 text-lg shadow-xl rounded-2xl mt-4">
                Contact Us Today
              </Link>
            </div>
          </div>
