const deskImg = '/images/desk_small.png';
const cubeImg = '/images/cubeImg.jpg';
const officeImg = '/images/officeImg.jpg';
const equipmentImg = '/images/equipment.jpg';
const loadedImg = '/images/loaded.jpg';
const wrapImg = '/images/wrapped.png';
const dolliesImg = '/images/Dollies.png';
const boxesImg = '/images/boxes.png';
const comMvgImg = '/images/comMvg.jpg';
...
export const services = [
    ...
    {
        slug: 'intrastate-installation-moving',
        title: 'Intrastate Installation & Moving',
        shortTitle: 'Intrastate Services',
        navLabel: 'Intrastate',
        featured: true,
        image: trucksImg,
        heroImage: comMvgImg,
        metaDescription:
            'Intrastate office furniture installation and moving across Florida. Licensed statewide service for commercial relocations, furniture install, and home moves within Florida.',
        keywords:
            'intrastate movers Florida, intrastate installation Florida, statewide moving company, Florida furniture installation, long distance moving within Florida',
        headline: 'Intrastate Installation & Moving Services in Florida',
        subheadline:
            'Licensed and insured installation and relocation anywhere in Florida — commercial offices, furniture projects, and residential moves without crossing state lines.',
        intro:
            'Headquarters Moving LLC provides intrastate installation and moving services throughout Florida. From Port Saint Lucie to Miami, Orlando, Tampa, and Jacksonville, we move and install offices, deliver furniture projects, and relocate homes within the state with one coordinated team.',
        benefits: [
            'Licensed intrastate moving across all of Florida',
            'Combined furniture installation and relocation services',
            'Commercial and residential intrastate capabilities',
            'Dedicated project management for multi-city moves',
            'After-hours and weekend scheduling available',
        ],
        features: [
            {
                title: 'Commercial Intrastate Relocation',
                description: 'Office and warehouse moves between Florida cities with furniture reinstall at destination.',
            },
            {
                title: 'Statewide Furniture Installation',
                description: 'Travel to your Florida location for cubicle, desk, and FF&E installation projects.',
            },
            {
                title: 'Residential Intrastate Moving',
                description: 'Full-service home relocations anywhere within Florida.',
            },
        ],
        faqs: [
            {
                question: 'What is intrastate moving?',
                answer:
                    'Intrastate moving means your origin and destination are both within Florida. We specialize in these statewide relocations and installation projects.',
            },
            {
                question: 'Do you install furniture and move offices on the same project?',
                answer:
                    'Yes. Many clients combine intrastate moving with office furniture installation at the new location for a single-vendor experience.',
            },
        ],
    },
    {
...
export const movingServices = services.filter((s) =>
    ['commercial-moving', 'residential-moving', 'intrastate-installation-moving'].includes(s.slug)
);

export const homepageServices = services.filter((s) =>
    ['office-furniture-installation', 'cubicle-installation', 'office-reconfiguration', 'intrastate-installation-moving'].includes(s.slug)
);
