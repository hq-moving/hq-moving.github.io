const officeFurnitureImg = '/images/officefurniture1.jpg';
const officeFurnitureCardImg = '/images/officefurniture2.jpg';
const cubeImg = '/images/cubicleinstall1.jpg';
const officeReconfigImg = '/images/officereconfig1.jpg';
const furnitureSetupImg = '/images/furnituresetup1.jpg';
const decomImg = '/images/decom1.jpg';
const commercialMovingImg = '/images/commercialmoving1.jpg';
const interstateImg = '/images/interstate1.png';
const wrapImg = '/images/wrapped.png';
const movingCouchImg = '/images/movingCouch.jpg';
...
export const services = [
    {
        ...
        featured: true,
        image: officeFurnitureCardImg,
        heroImage: officeFurnitureCardImg,
        metaTitle: 'Office Furniture Installation Services Florida | HQ Moving',
        metaDescription:
            'Headquarters Moving installs Herman Miller, Steelcase, Haworth, Knoll, and more across Florida. Free estimate — (772) 207-3720.',
        keywords:
        ...
        headline: 'Professional Office Furniture Installation Services — Florida',
        subheadline:
    ...
    },
    {
        ...
        metaDescription:
            'Expert cubicle assembly, reconfiguration, and systems installation across Florida. All major manufacturers. Free estimate.',
        keywords:
        ...
        headline: 'Cubicle Installation & Reconfiguration by Expert Installers',
        subheadline:
    ...
    },
    {
        ...
        featured: true,
        image: officeReconfigImg,
        heroImage: officeReconfigImg,
        metaDescription:
    ...
    },
    {
        ...
        featured: false,
        image: furnitureSetupImg,
        heroImage: furnitureSetupImg,
        metaDescription:
    ...
    },
    {
        ...
        metaDescription:
            'Professional office furniture decommissioning, disposal, and donation coordination across Florida. Serving facility managers and project coordinators.',
        keywords:
        ...
        headline: 'Office Furniture Decommissioning & Disposal Services in Florida',
        subheadline:
        ...
        faqs: [
            {
                question: 'What happens to furniture during decommissioning?',
                answer:
                    'We dismantle, remove, and route items to donation centers, recyclers, or approved disposal facilities. Certificates of recycling or disposal are available for corporate reporting.',
            },
            {
                question: 'Can decommissioning happen after business hours?',
                answer:
                    'Yes. After-hours and weekend removal is available to avoid disrupting active tenant operations.',
            },
            {
                question: 'Do you combine decommissioning with new furniture installation?',
                answer:
                    'Yes. Many clients use a single vendor for removal of old inventory and installation of new workstations — reducing mobilization costs and timeline gaps.',
            },
            {
                question: 'Can you remove only part of our existing furniture?',
                answer:
                    'Yes. Selective removal allows you to clear outdated sections while retaining usable inventory for reconfiguration elsewhere.',
            },
        ],
    },
    {
        ...
        featured: false,
        image: commercialMovingImg,
        heroImage: commercialMovingImg,
        metaDescription:
    ...
    {
        slug: 'interstate-installation-moving',
        title: 'Interstate Installation & Moving',
        shortTitle: 'Interstate Services',
        navLabel: 'Interstate',
        featured: true,
        image: interstateImg,
        heroImage: interstateImg,
        metaDescription:
            'Interstate office furniture installation and moving from Florida. We relocate offices and homes to and from other states and travel nationwide for commercial furniture installation projects.',
        keywords:
            'interstate movers Florida, interstate installation, Florida to out of state movers, office furniture installation nationwide, cross-country moving Florida',
        headline: 'Interstate Installation & Moving Services',
        subheadline:
            'From Florida to anywhere in the U.S. — and from other states into Florida. We move offices and homes across state lines and travel for commercial furniture installation nationwide.',
        intro:
            'Headquarters Moving LLC is based on the Treasure Coast and serves clients throughout Florida and across state lines. We handle moves from Florida to other states, relocations from other states into Florida, and travel to other states for office furniture installation, cubicle setup, and FF&E projects. Whether you are opening a new location, consolidating offices, or relocating your home, one team coordinates moving and installation.',
        benefits: [
            'Moves from Florida to other states and from other states to Florida',
            'Office furniture installation projects in Florida and other states',
            'Commercial and residential interstate relocation',
            'Combined moving and installation with one project manager',
            'Flexible scheduling including evenings and weekends',
        ],
        features: [
            {
                title: 'Florida to Out-of-State Moves',
                description:
                    'Commercial and residential relocations from Florida to Georgia, the Carolinas, Texas, the Northeast, and beyond.',
            },
            {
                title: 'Out-of-State to Florida Moves',
                description:
                    'Coordinated delivery and setup when your move ends in Florida — or starts here and heads elsewhere.',
            },
            {
                title: 'Interstate Furniture Installation',
                description:
                    'Travel to your out-of-state site for cubicle, desk, and modular furniture installation and reconfiguration.',
            },
        ],
        faqs: [
            {
                question: 'Do you handle moves from Florida to other states?',
                answer:
                    'Yes. We regularly move offices and homes from Florida to other states. Share your origin, destination, and timeline for a detailed estimate.',
            },
            {
                question: 'Can you install office furniture in states outside Florida?',
                answer:
                    'Yes. In addition to Florida projects, we travel to other states for commercial furniture installation, cubicle systems, and workspace setup.',
            },
            {
                question: 'Do you install furniture and handle the move on the same project?',
                answer:
                    'Yes. Many clients combine interstate moving with office furniture installation at the new location for a single-vendor experience.',
            },
        ],
    },
    {
...
export const movingServices = services.filter((s) =>
    ['commercial-moving', 'residential-moving', 'interstate-installation-moving'].includes(s.slug)
);

export const homepageServices = services.filter((s) =>
    ['office-furniture-installation', 'cubicle-installation', 'office-reconfiguration', 'interstate-installation-moving'].includes(s.slug)
);
